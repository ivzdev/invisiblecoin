...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("InvisibleCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("InvisibleCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("InvisibleCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "InvisibleCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"node1.invisiblecoin.net", "node1.invisiblecoin.net"},
    {"node2.invisiblecoin.net", "node2.invisiblecoin.net"},        
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("InvisibleCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("InvisibleCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("InvisibleCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("InvisibleCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. InvisibleCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("InvisibleCoin-start");
