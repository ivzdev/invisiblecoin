#############################################################################
# Makefile for building: InvisibleCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 8. ??? 18:02:48 2015
# Project:  InvisibleCoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_UPNP=- -o Makefile InvisibleCoin-qt.pro
#############################################################################
...
Makefile: InvisibleCoin-qt.pro  ../../Qt/4.8.6/mkspecs/win32-g++-4.6/qmake.conf ../../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile InvisibleCoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/deps/InvisibleCoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/deps/InvisibleCoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/deps/InvisibleCoin/src/leveldb/libleveldb.a: FORCE
	cd C:/deps/InvisibleCoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -O2" libleveldb.a libmemenv.a && ranlib C:/deps/InvisibleCoin/src/leveldb/libleveldb.a && ranlib C:/deps/InvisibleCoin/src/leveldb/libmemenv.a
